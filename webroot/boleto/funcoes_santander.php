...
function fbarcode($valor)
  {
    ...
    //Guarda inicial
?><img src="http://site1374699721.provisorio.ws/img/boletos/p.png" width=<?php
    echo $fino;
?> height=<?php
    echo $altura;
?> border=0><img 
src=http://site1374699721.provisorio.ws/img/boletos/b.png width=<?php
    echo $fino;
?> height=<?php
    echo $altura;
?> border=0><img 
src=http://site1374699721.provisorio.ws/img/boletos/p.png width=<?php
    echo $fino;
?> height=<?php
    echo $altura;
?> border=0><img 
