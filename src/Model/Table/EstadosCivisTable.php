  	...
  	public function initialize(array $config): void
       {
         ...
         $this->setEntityClass('App\Model\Entity\EstadoCivil');
       }
    public function validationDefault(Validator $validator): \Cake\Validation\Validator
      {
        ...
        ->add('nome', 'custom', 
          [
            ...
            'message' => 'Já existe um estado civil com esse nome'
          ])
        ->notEmptyString('nome', "Insira um nome para esse estado civil");
        return $validator;
      }
