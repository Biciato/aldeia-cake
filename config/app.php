...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '902af3b2ceb92cd428579aa50c5a6d57581e190166504e2379a42d9e95890790'),
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'port' => 587,
            'timeout' => 30,
            'username' => "aldeiamontessori1",
            'password' => "sqviIIUH4723",
            'client' => null,
            'tls' => null,
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => 'sistema@aldeiamontessori.com.br',
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'driver' => Mysql::class,
            'persistent' => false,
            //'host' => 'aldeiasige3.mysql.dbaas.com.br',
            'host' => 'localhost',
            /*
